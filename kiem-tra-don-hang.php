                        ...
                        <table class="table table-mycart">
                           ...
                           <tbody>
                              <tr ng-repeat="item in OrderDetails">
                                 <td>{{$index+1}}</td>
                                 <td class="image">
                                    <a href="san-pham/%7b%7bitem.ProductCode%7d%7d.php"><img src="notfound5031.php" class="img-responsive" /></a>
                                 </td>
                                 <td>
                                    <a href="san-pham/%7b%7bitem.ProductCode%7d%7d.php">{{item.ProductName}}</a>
                                 ...
                                 <td colspan="4">
                                    <table class="table">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td class="text-left"><b>Phí vận chuyển</b></td>
                                             <td class="text-right ">
                                                <b class="total-payment">
